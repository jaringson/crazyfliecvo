...
class CVOGekko:
    ...
    #         cvo = yaml.safe_load(file)
    #
    #         self.collisionRadius = cvo['collision_radius']
    #         self.max_vel = 0.3
    ...
    def get_best_vel(self, av1Xo, av1Vo, av1VelDes,
        ...
        for i in range(numOther):
            ...
            a = 2.0*self.collisionRadius #uncertaintyPos[i][0]+2.0*self.collisionRadius
            b = 2.0*self.collisionRadius #uncertaintyPos[i][1]+2.0*self.collisionRadius
            c = 2.0*self.collisionRadius #uncertaintyPos[i][2]+4.0*self.collisionRadius
        ...
        if not solve_success:
            ...
            sx.value = [av1VelDes[0,0]]
            sy.value = [av1VelDes[1,0]]
            sz.value = [av1VelDes[2,0]]
